...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Successfully retrieved items.' }),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get the item by id' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Successfully retrieved the item by id' }),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Put)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update an entire item by ID' }),
